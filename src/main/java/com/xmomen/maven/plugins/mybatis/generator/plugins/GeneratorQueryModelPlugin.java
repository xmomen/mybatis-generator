...
// */
//public class GeneratorQueryModelPlugin extends CommonPlugin {
//
...
//        logger.info(MessageFormat.format("Generating QueryModel class for {0}", introspectedTable.getTableConfiguration().getTableName()));
//        setProperty();
//        validateProperty();
...
//                "Query{0}.java",
//                targetPackage,
//                FreemarkerDefine.QUERY_MODEL_TEMPLATE);
