...
// */
//public class GeneratorServicePlugin extends CommonPlugin {
//
...
//        logger.info(MessageFormat.format("Generating Service class for {0}", introspectedTable.getTableConfiguration().getTableName()));
//        setProperty();
//        validateProperty();
//        if(modulePackage != null && targetPackage == null){
//            targetPackage = modulePackage + ".service";
//        }
//        TemplatePropertyDefine templatePropertyDefine = new TemplatePropertyDefine(
//                "{0}Service.java",
//                targetPackage,
//                FreemarkerDefine.SERVICE_TEMPLATE);
