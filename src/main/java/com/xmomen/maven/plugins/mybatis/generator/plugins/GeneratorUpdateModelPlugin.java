...
/**
 * UpdateModel类代码自动生成插件
 * Created by tanxinzheng on 16/8/27.
 */
public class GeneratorUpdateModelPlugin extends AbstractGeneratorPlugin {


    @Override
    public TemplatePropertyDefine generate(IntrospectedTable introspectedTable, TemplatePropertyDefine templatePropertyDefine) {
        // 指定模板文件
        templatePropertyDefine.setTemplateFileName(FreemarkerDefine.UPDATE_MODEL_TEMPLATE);
        // 输出目录
        templatePropertyDefine.setTargetFileName(templatePropertyDefine.getDomainObjectClassName()+"Update.java");
        // 模块包路径
