...
/**
 * CreateModel类代码自动生成插件
 * Created by tanxinzheng on 16/8/27.
 */
public class GeneratorCreateModelPlugin extends AbstractGeneratorPlugin {


    @Override
    public TemplatePropertyDefine generate(IntrospectedTable introspectedTable, TemplatePropertyDefine templatePropertyDefine) {
        // 指定模板文件
        templatePropertyDefine.setTemplateFileName(FreemarkerDefine.CREATE_MODEL_TEMPLATE);
        // 输出目录
        templatePropertyDefine.setTargetFileName(templatePropertyDefine.getDomainObjectClassName()+"Create.java");
        // 模块包路径
